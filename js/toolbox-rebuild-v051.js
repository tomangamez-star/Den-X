(() => {
  ...
  if(!editor||!toolbox||!quick||!viewport||editor.dataset.denxV051==="1")return;

  editor.dataset.denxV051="1";
  editor.classList.remove("denx-v050-shell");
  editor.classList.add("denx-v051-shell");

  const left=document.createElement("div");
  left.className="denx-v051-left";
  left.id="denxV051Left";

  const stage=document.createElement("div");
  stage.className="denx-v051-stage";
  stage.id="denxV051Stage";
  ...
  function showIndex(index,{reset=false}={}){
    ...
    sections.forEach((section,i)=>{
      ...
      section.classList.toggle("denx-v051-active",active);
  ...
  sections.forEach(section=>{
    ...
    section.addEventListener("touchstart",event=>{
      if(!section.classList.contains("denx-v051-active"))return;
    ...
    section.addEventListener("touchend",event=>{
      if(!gesture||!section.classList.contains("denx-v051-active"))return;
