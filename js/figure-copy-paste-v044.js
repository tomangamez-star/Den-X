(() => {
  ...
  copyBtn.innerHTML = '<span class="tool-icon">⧉</span><span class="tool-label">Copy</span>';
  ...
  pasteBtn.innerHTML = '<span class="tool-icon">▣</span><span class="tool-label">Paste</span>';
